<%@ Page Title="" Language="C#" MasterPageFile="~/ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciGüncelle.aspx.cs" Inherits="UDEMY_1.OgrenciGüncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <div class="form-group">
            <div>
                <asp:Label for="TxtOgrid" runat="server">Öğrenci İD</asp:Label>
